/* testServicetestServiceProxy.cpp
...
int testServiceProxy::RemoteConfig(const char *endpoint, const char *soap_action, test__ConfigReq req, test__ConfigRsp &rsp)
{	struct soap *soap = this;
	...
	soap_tmp_test__RemoteConfig.req = req;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize_test__RemoteConfig(soap, &soap_tmp_test__RemoteConfig);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put_test__RemoteConfig(soap, &soap_tmp_test__RemoteConfig, "test:RemoteConfig", NULL)
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	rsp.soap_get(soap, "test:ConfigRsp", "");
	if (soap->error)
